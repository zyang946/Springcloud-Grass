package com.springboot.cloud.security.jwt;

import com.springboot.cloud.Exception.TokenException;
...
public class JWTUtil {
    ...
    public static Authentication getJWTAuthentication(ServletRequest request) throws TokenException {
    ...
    private static boolean validateToken(String token) throws TokenException {
        try {
            Jws<Claims> claimsJws = getClaims(token);
